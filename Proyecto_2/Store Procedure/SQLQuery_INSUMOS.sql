...
CREATE TABLE Insumos(
	...
	flagEstado		CHAR(1)		-- Eliminación Lógica : '0' y '1'
)
GO
--------------------------------------------------------------
...
sp_Alterar_Insumos 1,'LIMÓN LIMEÑO', 5, 1.9, 1000
sp_Alterar_Insumos 1,'LIMÓN TARAPACA', 5, 1.9, 1000

SELECT * FROM Insumos
GO

--------------------------------------------------------------
CREATE OR ALTER PROC sp_Eliminar_Insumos	-- Elimación Lógica
@idInsumo		INT
AS
